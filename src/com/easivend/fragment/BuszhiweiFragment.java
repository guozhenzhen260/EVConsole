...
//    private Handler mainhand=null,childhand=null;   
    ...
    public interface BuszhiweiFragInteraction
    {
         ...
         * @param str
         */
        //void BuszhiweiGoodselect();//切换到Busgoodsselect页面
        void BuszhiweiFinish();      //切换到business页面
    }
    @Override
			...
			Bundle savedInstanceState)
	{
		...
		imgbtnbuszhiweiqxzf.setOnClickListener(new OnClickListener() {
		    ...
		    public void onClick(View arg0) {		    	 
		    	listterner.BuszhiweiFinish();//步骤二、fragment向activity发送回调信息		    	
		    }
		});
    ...
    private class buportInterfaceImp implements BusPortFragInteraction//加载接口
	{
		...
		public void BusportSend(String str) {
			// TODO Auto-generated method stub
			txtbuszhiweirst.setText("交易结果:"+str);
