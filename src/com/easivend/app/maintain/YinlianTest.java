				...
				switch (msg.what)
				{
					case Yinlianhttp.SETMAIN://子线程接收主线程消息
						try {
							...
							txtweixingtest.setText("银联二维码结果:"+zhuhe.toString());
					...
					case Yinlianhttp.SETFAILNETCHILD://子线程接收主线程消息
						txtweixingtest.setText("银联二维码结果:"+msg.obj.toString());
						break;	
					case Yinlianhttp.SETPAYOUTMAIN://子线程接收主线程消息
						txtweixingtest.setText("银联二维码结果:退款成功");
						break;
					case Yinlianhttp.SETDELETEMAIN://子线程接收主线程消息
						txtweixingtest.setText("银联二维码结果:撤销成功");
						break;	
					case Yinlianhttp.SETQUERYMAINSUCC://子线程接收主线程消息	
						txtweixingtest.setText("银联二维码结果:交易成功");
						break;		
